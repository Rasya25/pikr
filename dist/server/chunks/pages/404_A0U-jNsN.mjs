import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, e as renderSlot, f as createAstro, s as spreadAttributes, u as unescapeHTML, g as renderComponent, h as renderHead } from '../astro_C0zkYug8.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
/* empty css                           */
...
}, "/home/user/pikr/src/components/Hero.astro", void 0);
...
const $$MainHead = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    title = "PIK R | SMAN 2 Mojokerto",
    description = "Incada Youth Care and Communication"
  } = Astro2.props;
...
}, "/home/user/pikr/src/components/MainHead.astro", void 0);
...
}, "/home/user/pikr/src/components/Icon.astro", void 0);
...
}, "/home/user/pikr/src/components/ThemeToggle.astro", void 0);
...
const $$Nav = createComponent(($$result, $$props, $$slots) => {
  ...
  const textLinks = [
    ...
    { label: "Vidsi", href: "/vidsi/" },
    { label: "GemZ", href: "/gemz/" }
  ];
  const iconLinks = [
    { label: "Instagram", href: "https://instagram.com/rasyooptrr", icon: "instagram-logo" },
    { label: "YouTube", href: "https://www.youtube.com/channel/UCs033w86geJ_XuZ9DAA8FQQ", icon: "youtube-logo" }
  ];
  return renderTemplate`${maybeRenderHead()}<nav data-astro-cid-dmqpwcec> <div class="menu-header" data-astro-cid-dmqpwcec> <a href="/" class="site-title" data-astro-cid-dmqpwcec> <img width="30" height="30" src="/assets/lo1.png" alt="SMAN 2 Kota Mojokerto" data-astro-cid-dmqpwcec> <!-- <Icon icon="terminal-window" color="var(--accent-regular)" size="1.6em" gradient /> -->
PIK-R SMAN 2 MOJOKERTO
  ...
  ], "class:list")}${addAttribute(href, "href")} data-astro-cid-dmqpwcec> ${label} </a> </li>`)} </ul> </noscript> <noscript> <div class="menu-footer" data-astro-cid-dmqpwcec> <div class="socials" data-astro-cid-dmqpwcec> ${iconLinks.map(({ href, icon, label }) => renderTemplate`<a${addAttribute(href, "href")} class="social" target="_blank" rel="noopener noreferrer" data-astro-cid-dmqpwcec> <span class="sr-only" data-astro-cid-dmqpwcec>${label}</span> ${renderComponent($$result, "Icon", $$Icon, { "icon": icon, "data-astro-cid-dmqpwcec": true })} </a>`)} </div> </div> </noscript> <div id="menu-content" hidden data-astro-cid-dmqpwcec> <ul class="nav-items" data-astro-cid-dmqpwcec> ${textLinks.map(({ label, href }) => renderTemplate`<li data-astro-cid-dmqpwcec> <a${addAttribute(Astro2.url.pathname === href, "aria-current")}${addAttribute([
    "link",
    {
      active: Astro2.url.pathname === href || href !== "/" && Astro2.url.pathname.startsWith(href)
    }
...
}, "/home/user/pikr/src/components/Nav.astro", void 0);
...
Designed & Developed in Mojokerto with <a href="https://astro.build/" data-astro-cid-sz7xmlte>SMAN 2 Kota Mojokerto</a> ${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2em", "data-astro-cid-sz7xmlte": true })} </p> <p data-astro-cid-sz7xmlte>&copy; ${currentYear} Inscada Youth Care and Communication</p> </div> <p class="socials" data-astro-cid-sz7xmlte> <a href="https://instagram.com/youthcare_inscada" data-astro-cid-sz7xmlte="" data-astro-cid-sz7xmlte> Instagram</a> <a href="https://www.youtube.com/channel/UCs033w86geJ_XuZ9DAA8FQQ" data-astro-cid-sz7xmlte="" data-astro-cid-sz7xmlte>Youtube</a> </p> </footer> `;
}, "/home/user/pikr/src/components/Footer.astro", void 0);
...
}, "/home/user/pikr/src/layouts/BaseLayout.astro", void 0);
...
}, "/home/user/pikr/src/pages/404.astro", void 0);

const $$file = "/home/user/pikr/src/pages/404.astro";
const $$url = "/404";
...
export { $$BaseLayout as $, _404 as _, $$Hero as a, $$Icon as b };
